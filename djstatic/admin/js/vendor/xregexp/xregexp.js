    ...
    self.union = function (patterns, flags) {
        ...
        for (i = 0; i < patterns.length; ++i) {
            ...
            if (self.isRegExp(pattern)) {
                ...
                // are independently valid; helps keep this simple. Named captures are put naval-battle-back
 ...
 */
    XRegExp.build = function (pattern, subs, flags) {
        ...
        // helps keep this simple. Named captures will be put naval-battle-back
